<?php
	...
	class Hunter implements ISpace_ship
	{
		...
		***********************************************************************/
		...
		public function type_w($val)		{ $this->_type = $val; }
		public function name_w($val)		{ $this->_name = $val; }
		public function size_w($val)		{ $this->_size = $val; }
		public function shell_w($val)		{ $this->_shell = $val; }
		public function pp_w($val)			{ $this->_pp = $val; }
		public function speed_w($val)		{ $this->_speed = $val; }
		public function maneuver_w($val)	{ $this->_maneuver = $val; }
		public function shield_w($val)		{ $this->_shield = $val; }
		public function weapon_w($val)		{ $this->_weapon = $val; }
